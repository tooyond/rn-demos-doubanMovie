        ...
        style={[styles.container, this.props.style]}>
          ...
          <View style={{flex: 1}}>
            <View style={styles.content} collapsable={false}>
              <Animated.Image
                source={this.props.addedImageSource || require('./img/my-schedule-icon.png')}
...
module.exports.__cards__ = (define) => {
  ...
  define('Inactive', (state = true, update) =>
    <YButton isAdded={state} onPress={() => update(!state)} />);
  ...
  define('Animated', (state = false, update) => {
    f = () => update(!state);
    return <YButton isAdded={state} onPress={() => {}} />;
  });
};